...
<div class="card card-custom mt-10">
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        <div class="card-title">
            <h3 class="card-label">Events
                <div class="text-muted pt-2 font-size-sm">All Events List</div></h3>
            </div>
            <div class="card-toolbar">
                
                <!--begin::Button-->
                <a href="{{route('events.add')}}" class="btn btn-primary font-weight-bolder">
                ...
                <table class="" id="myTable" style="width: 100%;" border="0">
                    <thead>
                        <tr>
                            ...
                            <th title="Field #2">Event Date</th>
                            <th title="Field #3">Category</th>
                            <th title="Field #3">Organizer</th>
                            <th title="Field #5">Created At</th>
                            <th title="Field #6">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($events as $key => $blog)
                        @php
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="symbol symbol-35 symbol-light-success">
                                        <span class="symbol-label font-size-h5 font-weight-bold">{{$blog->title[0]}}</span>
                                    </span>
                            ...
                            <td>
                                <a href="{{route('events.edit', $blog->id)}}" class=" btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon">
                                    <i class="flaticon-edit"></i>
                                </a>
                                <a href="javascript:;" data-url="{{route('events.delete', $blog->id)}}" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon delete">
